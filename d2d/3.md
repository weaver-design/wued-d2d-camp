...
[Bootstrap 卡片](https://getbootstrap.com/docs/4.3/components/card/#image-overlays)

[Bootstrap 头部 banner](https://getbootstrap.com/docs/4.3/components/jumbotron/)
...
var guy = {
  name: 'Turkyden',
  avatar: 'http://placehold.it/500x350',
